...
public class UsefulConstants {
	...
	public final static String supportEmail="pi_ramsey_squared@outlook.com"; //This must be a stringed constant per ACRA set up. Will need to look at examining how to work around this later.
